...
namespace RobControls
{
    public class BKSlider:Slider
    {
        ...
        public static readonly RoutedEvent OnDeleteBookmarkEvent = EventManager.RegisterRoutedEvent("OnDeleteBookmark", RoutingStrategy.Bubble, typeof(RoutedPropertyChangedEventHandler<GenericBookmark>), typeof(BKSlider));
